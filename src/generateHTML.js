...
function generateHTML(teamMembers) {
    ...
    let strCards = "<html lang='en'><head><meta charset='UTF-8' /><meta http-equiv='X-UA-Compatible'content='IE=edge' /> <meta name='viewport' content='width=device-width, initial-scale=1.0' /><title>MiddlewareStaticAssets</title><link rel='stylesheet' href='./styles/index.css' /></head><header>My Team</header>"
